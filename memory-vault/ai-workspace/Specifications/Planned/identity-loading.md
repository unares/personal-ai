...
| Host Path | Container Path | Mode | Purpose |
|-----------|---------------|------|---------|
| `containers/clark/CLAUDE.md` | `/home/clark/.claude/CLAUDE.md` | ro | Clark CLAUDE.md |
| `containers/clark/settings.json` | `/home/clark/.claude/settings.json` | ro | Claude Code settings |
